...
function Fees() {
  const fees = [
    ["Art Classes", "₹500", "₹2,600", "13.33% off", "₹4,600", "16.36% off"],
    ["Uprisers", "₹500", "₹2,700", "10% off", "₹4,900", "10.91% off"],
    ["Nova Leap", "₹800", "₹4,100", "14.58% off", "₹7,300", "17.05% off"],
    ["Ramanujan", "₹1,200", "₹6,200", "13.89% off", "₹11,100", "15.91% off"],
    ["Vector", "₹1,300", "₹6,800", "12.82% off", "₹12,200", "14.69% off"],
  ];
  return (
    <>
      <Meta
